 ...
 */
public class RecycleAdapterPostCurboard extends RecyclerView.Adapter<RecycleAdapterPostCurboard.ViewHolder> {

    private List<CurboardPosts> listPost;
    ...
    @Override
    public RecycleAdapterPostCurboard.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(final RecycleAdapterPostCurboard.ViewHolder viewHolder,final int i) {
    ...
    public RecycleAdapterPostCurboard(List<CurboardPosts> list, Activity activity, RecyclerView recyclerView)
    {
        listPost = list;
    ...
    public void add(CurboardPosts post)
    {
        listPost.add(post);
    }
